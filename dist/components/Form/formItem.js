...
export var FormItem = function (_a) {
    ...
    return (React.createElement("div", { className: rowClasses },
        label && (React.createElement("div", { className: "vanilla-form-item-label" },
            React.createElement("label", { className: labelClasses, title: label }, label))),
        React.createElement("div", { className: "vanilla-form-item" },
            React.createElement("div", { className: itemClasses }, returnChildNode),
            hasError && React.createElement("div", { className: "vanilla-form-item-explain" }, error[0].message))));
};
